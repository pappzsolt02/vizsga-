...
print(f"\nA legnagyobb elemem a lsitában a {legnagyobb_elem()}")
print(szamok[0])

keresett=int(input("Keresett szám: "))
# keresett_eredmeny=keresett_szam(keresett)
if keresett_szam(keresett)==False and keresett_szam(keresett)!=0:
    print("A keresett elem nincs benne a listában.")
else:
    print(f"A keresett szám {keresett} és a helye  {keresett_szam(keresett)+1}")

print(f"A negativ számok átlaga: {neg_atlag()}")